...
<head>
  ...
  <title>ARV | Judge Task Page</title>
            ...
            <div class="col-md-12">
            	<table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										...
										$judgeid=$_SESSION['user_session']; 
											
											
										$viwerstmt = $project->dataviewforjudge($judgeid);
										...
										$currentDate = $date->format('m/d/Y');
  										...
  										{
  		 									while($row=$viwerstmt->fetch(PDO::FETCH_ASSOC)){
                								...
                								echo "<tr>";
													...
													{
														echo "<td>Judging Time Expired </td>";
				 									}elseif(false){//$project->check_image_uploade($Viewer_Id, $row['Project_Id']) > 0){
				 										echo "<td>Sketch uploading is Completed</td>";	
				 									}
													else
													{
                										echo "<td><a href='judge_task_images.php?task_id=". $row['Project_Id']."'>Proceed to Judgeing</a></td>";
