              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  $msg = new Messaging($db);
          		  $msgstmt = $msg->GetBySenderID($_SESSION['user_session']);
                       ...
                       while ($row = $msgstmt->fetch(PDO::FETCH_ASSOC)) {
                       		...
                       		//echo "<option value='{$id}'>{$first_name} &nbsp; {$last_name}</option>";
                    			...
                    			echo "<td class='mailbox-name'><a href=readmail.php?msg=".$row['idMsg'].">";
                    			
								$user = new User($db);
          		  				$userstmt = $user->readAllUser();
								 while ($urow = $userstmt->fetch(PDO::FETCH_ASSOC)) {
                                      extract($urow);
                                      if($urow['id'] == $row['receiver'])
                                      	echo "{$first_name} &nbsp; {$last_name} &nbsp; ({$user_role})";
                                 }
                    			
                    			echo "</a></td>";
                    			echo "<td class='mailbox-subject'>{$title}</td>";
