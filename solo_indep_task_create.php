...
<head>
  ...
  <title>ARV | Solo Independent Task </title>
...
<form id="demo-form2" method="post" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select name="viewers" class="form-control" required="required">
                                                        <?php
                                            ...
                                            <div class = "form-group">
                                                ...
                                                <div class = "col-md-6 col-sm-6 col-xs-12">
                                                    <select name = "judges" class = "form-control" required="required">
                                                        <?php
                                                        if ($viewernum != 0) {
