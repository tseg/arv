...
if (isset($_POST['savestg'])) {
    ...
    try {
        ...
        $projectviewers = $_POST['viewer'];
        //for ($v = 0; $v < count($projectviewers); $v++) {
        	
            $viewer = new ViewerGroup($db);
			$viewer->viewer_id = $projectviewers;
        ...
        $projectjudges = $_POST['viewer'];
        //for ($j = 0; $j < count($projectjudges); $j++) {
        	
        	$judge = new JudgeGroup($db);
        	$judge->judge_id = $projectjudges;
        ...
        //for($isv = 0; $isv < count($projectviewers); $isv++){
           ...
           // for($isj = 0; $isj < count($projectjudges); $isj++){ 
                $crudobj->createImageSketch($projectjudges,9,11,$timestamp,$projectid,$projectviewers,9);
           // }
        //}
...
<head>
  ...
  <title>ARV | Solo Self Practice </title>
...
<form id="demo-form2" method="post" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Image Viewer and Judge</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select name="viewer" class="form-control" required="required">
                                                        <?php
