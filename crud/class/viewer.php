...
class Viewer
{
    ...
    function readAllViewer()
    {

        $query = "SELECT * FROM  " . $this->table_name . " WHERE user_role='Viewer' ORDER BY first_name ASC";
	...
	function readOneByNameEmail()
    {
        ...
        $query = "SELECT * FROM  " . $this->table_name . " WHERE FName = ? and Email = ? LIMIT 0,1";
