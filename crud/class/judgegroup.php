...
class JudgeGroup
{
    ...
    private $conn;
    private $table_name = "tbl_judge_group";
    ...
    function create()
    {
        $query = "INSERT INTO " . $this->table_name . " SET  Judge_Id = ?, Project_Id = ?, Date = ?";

        $stmt = $this->conn->prepare($query);

        $stmt->bindParam(1, $this->judge_id);
