...
<head>
  ...
  <title>ARV | Manage User form</title>
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12">
            	<div class="container">
                     <a href="user_add.php" class="btn btn-large btn-info"><i class="glyphicon glyphicon-plus"></i> &nbsp; Add Records</a>
                </div>
...
<!-- delete confirmation -->
<script src="plugins/box/bootbox.min.js"></script>
<!-- AdminLTE App -->
				...
				danger: {
				  ...
				  callback: function() {
					  ...
					  */
					  ...
					  $.post('user_delete.php', { 'delete':pid })
					  .done(function(response){
						  bootbox.alert(response);
						  parent.fadeOut('slow');
					  })
