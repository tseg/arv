...
<div class="row">
   ...
   <div class="ln_solid"></div>
	...
	<div class="col-md-6">
              ...
              <div class="form-group">
                <label>Viewer Sketch Deadline Date* <small>(<?php echo $project->Upload_Deadline; ?>)</small></label>

                <div class="input-group date">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                  </div>
                  <input id="uploadlast" name="uploadlast" type="text" class="form-control pull-right" value="<?php echo $project->Upload_Deadline; ?>" required="required">
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.Viewer Sketch Deadline Date form group -->
                            <!-- Viewer Sketch Deadline Date -->
              <div class="form-group">
                <label>Judge Deadline * <small>(<?php echo $project->Judge_Deadline; ?>)</small> </label>

                <div class="input-group date">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                  </div>
                  <input id="judgetime" name="judgetime" type="text" class="form-control pull-right" value="<?php echo $project->Judge_Deadline; ?>" required="required">
                </div>
                <!-- /.input group -->
              </div>
              ...
              <!-- Trade Time Start -->
              <div class="form-group">
                <label>Trade Start Date * <small>(<?php echo $project->Place_Date_Time; ?>)</small> </label>
				<?php $input = $project->Place_Date_Time;;
                ...
                <div class="input-group date">
                  ...
                  <input id="tradestart" name="tradestart" type="text" class="form-control pull-right" value="<?php echo $fields[0]; ?>" required="required">
                </div>
                <!-- /.input group -->
              </div>
              ...
              <div class="form-group">
                <label>Trade Exit Date * <small>(<?php echo $project->Exit_Date_Time; ?>)</small></label>

                <div class="input-group date">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                  </div>
                  <input id="tradeexit" name="tradeexit"  type="text" class="form-control pull-right" value="<?php echo $project->Exit_Date_Time; ?>" required="required">
                </div>
                <!-- /.input group -->
              </div>
              ...
              <div class="form-group">
                <label>Notification Date * <small>(<?php echo $project->Notification_Time; ?>)</small> </label>

                <div class="input-group date">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                  </div>
                  <input id="notiftime" name="notiftime" type="text" class="form-control pull-right" value="<?php echo $project->Notification_Time; ?>" required="required">
                </div>
                <!-- /.input group -->
              </div>
