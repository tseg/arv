...
if (isset($_POST['btn-update'])) {
	...
	if ($crud->updatev($email, $contact,$username,$password,$Viewer_ID)) {
        header("Location:user_edit.php?Success");
    } else {
        header("Location:user_edit.php?failed");
    }
}*/
?>
...
<head>
  ...
  <title>ARV| Edit User Information</title>
          ...
          <div class="row">
			...
			?>
				...
				<div class="alert alert-success alert-dismissible">
					...
					<strong>Ok!</strong> Changes was saved successfully !
				</div>
				...
				<div class="alert alert-danger alert-dismissible">
					<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
					<strong>SORRY!</strong> ERROR while Saving changes !
				</div>
				<?php
			}			
			?>
			<form class="form-horizontal" method='post'>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" name="first_name" id="first_name" value="<?php echo $user->firstname; ?>" class="form-control" required/>
					</div>
				</div>
				<div class="form-group">
					<label for="last_name" class="col-sm-2 control-label">Last Name</label>
					<div class="col-sm-8">
						<input type="text" name="last_name" id="last_name" value="<?php echo $user->lastname; ?>" class="form-control" required/>
					</div>
				</div>
                <div class="form-group">
                  <label for="email_id" class="col-sm-2 control-label">Email</label>
                  <div class="col-sm-8">
                    <input type="email" name="email_id" value="<?php echo $user->email; ?>" class="form-control" id="inputEmail3"  required/>
                  </div>
                </div>
                <div class="form-group">
                	<label for="contact_no" class="col-sm-2 control-label"> Phone Number</label>
                	<div class="col-sm-8">
                		<input type"text" name="contact_no" value="<?php echo $user->contactno; ?>" id="contact_no" class="form-control" required />
                	</div>
                </div>
                <div class="form-group">
                	...
                	<div class="col-sm-8">
                		...
                		<?php }else { ?>
							<input name="optionsRadios" id="optionsRadios1" value="Admin" checked="" type="radio">Admin
						<?php } ?>
                		<?php if($user->userrole == "Judge"){ ?>
						<input name="optionsRadios" id="optionsRadios2" value="Judge" checked="" type="radio">Judge 
						<?php }else{ ?>
						<input name="optionsRadios" id="optionsRadios2" value="Judge" type="radio">Judge 	
						<?php }?>
						<?php if($user->userrole =="Viewer"){ ?>
						<input name="optionsRadios" id="optionsRadios3" value="Viewer" checked="" type="radio">Viewer 	
						<?php }else{ ?>
