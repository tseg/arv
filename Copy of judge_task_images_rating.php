        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-xs-6">
                ...
                <img src="upload/<?php echo $srcup; ?>" class="img-rounded" width="200px" height="200px" />
				<div class="col-lg-4">	
					...
					<tr>
                                        ...
                                        <td>Rate</td>
                                        <td>
                                        	<input type='number' name="reateup" id="rate" required="required" min="0.0" max="4.0" class="form-control" value="<?php echo $crow['Rate_Up'];?>">
                                        </td>
										<td>Confidence Value</td>
                                        <td>
                                        	<input type='number' name="confup" required="required" id="confidence" min="1" max="10" class="form-control" value="<?php echo $crow['Confidence_Value_Up'];?>">
                                        </td>
                                        	<?php 
											}else{ ?>
										...
										<td>Rate</td>
                                        <td>
                                        	<input type='number' name="reateup" id="rate" required="required" min="0.0" max="4.0" class="form-control" >
                                        </td>
										<td>Confidence Value</td>
                                        <td>
                                        	<input type='number' name="confup" required="required" id="confidence" min="1" max="10" class="form-control" >
                                        </td>
            ...
            <div class="col-xs-6">
                ...
                <img src="upload/<?php echo $srcdown;?>" class="img-rounded" width="200px" height="200px" />
				<div class="col-lg-4">				
					<tr>
                                        ...
                                        ?>
                                        <td>Rate</td>
                                        <td><input type='number' name="reatedown" id="rate" required="required"min="0.0" max="4.0" class="form-control" value="<?php echo $crow['Rate_Down'];?>"></td>
										<td>Confidence Value</td>
                                        <td><input type='number' name="confdown" required="required" id="confidence" min="1" max="10" class="form-control" value="<?php echo $crow['Confidence_Value_Down'];?>"></td>
										<!-- To hold the current Id of image being viewed--> 
                                        	<?php 
											}else{ ?>
												
										<td>Rate</td>
                                        <td><input type='number' name="reatedown" id="rate" required="required"min="0.0" max="4.0" class="form-control"></td>
										<td>Confidence Value</td>
