...
if (isset($_GET['pid']) && !empty($_GET['pid'])) {
    	$practice->id = $_GET['pid'];
	
    	//$practice->Image_Path = $img;
		...
		if(empty($practice->Feedack_Image)){
			...
			$practice->Feedack_Image = $img;
			$practice->image_feedback();
...
<head>
  ...
  <title>ARV | Practice Feedback</title>
...
?>
            	...
            	<form method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <table class="table table-bordered table-responsive">
                            	<tr>
                                    <td>Your feedback is ready! </td>
                                    <td><input class="input-group" type="hidden" name="id" value="<?php  echo $_GET['pid']; ?>" /></td>
                               </tr>
                               <tr>
                                    <td colspan="2"><button type="submit" name="btnsave" class="btn btn-default">
                                            <span class="glyphicon glyphicon-picture"></span> &nbsp; Show me the Feedback
                                        </button>
                                    </td>
                                </tr>
...
if (isset($_POST['btnsave'])) {
	...
	$practice->readOne();
	//echo "upload/".$practice->Image_Path;
	//echo "<br> viewer_upload/".$practice->Feedack_Image;
	//echo "<div><img src=".$path . $img." /></div>";
?>	
	<div class="row">
    <div class="col-lg-6 col-sm-6 col-xs-12">
        <a href="#">
             <img style="width: 400px; height: 400px; display: block;" src="<?php echo "viewer_upload/".$practice->Image_Path; ?>" class="thumbnail img-responsive">
        </a>
    </div>
     <div class="col-lg-6 col-sm-6 col-xs-12">
        <a href="#">
             <img style="width: 400px; height: 400px; display: block;" src="<?php echo "upload/".$practice->Feedack_Image; ?>" class="thumbnail img-responsive">
        </a>
    </div>
    </div>
<?php
